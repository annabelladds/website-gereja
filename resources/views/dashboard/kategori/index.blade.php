...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h4 class="h4">Kategori Berita</h4>
</div>
...
<div class="table-responsive small">
    <a href="/dashboard/kategori/create" class="btn btn-primary mb-3">Tambah Kategori Baru</a>
    <table class="table table-striped table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $kategori->name }}</td>
                <td class="actions">
                  <form action="/dashboard/kategori/{{ $kategori->slug }}/edit" method="get" class="d-inline">
                    @csrf
