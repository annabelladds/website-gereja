...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h4 class="h4">Membuat Dokumentasi Baru</h4>
  </div>
  <form method="post" action="/dashboard/galeri" class="mb-5" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" id="event_date" name="event_date" class="form-control @error('event_date') is-invalid @enderror" required value="{{ old('event_date') }}">
      @error('event_date')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
    ...
    <div class="mb-3">
      ...
      <input type="text" id="formatted_date" class="form-control @error('formatted_date') is-invalid @enderror" readonly value="{{ old('formatted_date') }}">
    ...
    <div class="mb-3">
        ...
        <img class="img-preview1 img-fluid mb-2 col-sm-5">
        <input class="form-control @error('image1') is-invalid @enderror" type="file" id="image1" name="image1" onchange="previewImage1()">
        @error('image1')
        <div class="invalid-feedback">
          {{ $message }}
        </div>
