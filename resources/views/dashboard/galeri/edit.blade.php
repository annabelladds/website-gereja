...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h4 class="h4">Edit Dokumentasi</h4>
  </div>
  <form method="post" action="/dashboard/galeri/{{ $galeri->slug }}" class="mb-5" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        @if($galeri->image1)
          <img src="{{ asset('storage/' . $galeri->image1) }}" class="img-preview1 img-fluid mb-2 col-sm-5 d-block">
        @else
    ...
    <div class="mb-3">
        ...
        @if($galeri->image2)
          <img src="{{ asset('storage/' . $galeri->image2) }}" class="img-preview2 img-fluid mb-2 col-sm-5 d-block">
        @else
    ...
    <div class="mb-3">
        ...
        @if($galeri->image3)
          <img src="{{ asset('storage/' . $galeri->image3) }}" class="img-preview3 img-fluid mb-2 col-sm-5 d-block">
        @else
